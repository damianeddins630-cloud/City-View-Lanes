...
export function bookingReceivedEmail(name: string) {
  return {
    ...
    body: `Hi ${name},\n\nThanks for your party application at CityView Lanes. It is under review. We will notify you when it is approved or denied.\n\n— CityView Lanes\n(817) 346-0333`,
  };
}
...
export function leagueReceivedEmail(name: string, leagueName: string) {
  return {
    ...
    body: `Hi ${name},\n\nWe received your league application for "${leagueName}". It is under review. We will notify you when it is approved or denied.\n\n— CityView Lanes\n(817) 346-0333`,
  };
}
...
export function employmentReceivedEmail(name: string, position: string) {
  return {
    ...
    body: `Hi ${name},\n\nThank you for applying for ${position || "a position"} at CityView Lanes. Your application is under review. We will notify you when there is a decision.\n\n— CityView Lanes\n(817) 346-0333`,
  };
}
